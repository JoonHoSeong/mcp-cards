...
source: ../raw/skills/hsb-app/SKILL.md
...
- **Skill ID:** `hsb-app`
- **Purpose:** Discover and run Holoscan Sensor Bridge example applications on a connected devkit. Filters available apps by the user's platform, HSB software version, board type, and sensors. Supports timed execution, failure analysis, code-edit suggestions, and iterative re-runs.
- **Canonical source:** [../raw/skills/hsb-app/SKILL.md](../raw/skills/hsb-app/SKILL.md)
...
See [references/phase-details.md](../raw/skills/hsb-app/references/phase-details.md) for full step-by-step phase instructions.
...
After every app run, stop and remove the container. See [references/phase-details.md](../raw/skills/hsb-app/references/phase-details.md) for the cleanup pattern.
