...
source: ../raw/skills/hsb-flash/SKILL.md
...
- **Skill ID:** `hsb-flash`
- **Purpose:** Flash the FPGA on an HSB board connected to an NVIDIA devkit. Supports HSB Lattice boards (FPGA versions 2407, 2412, 2507, 2510) and Leopard Imaging VB1940 "all-in-one" cameras (FPGA versions 2507, 2510). Uses release-specific YAML manifests and board-type-specific program commands. Lattice and VB1940 commands must never be mixed.
- **Canonical source:** [../raw/skills/hsb-flash/SKILL.md](../raw/skills/hsb-flash/SKILL.md)
...
Invoke this skill by typing `/hsb-flash [OPTIONS]`. The skill detects the board type automatically, presents a flashing plan, and prompts for confirmation before each flash step. See [references/help-text.md](../raw/skills/hsb-flash/references/help-text.md) for the full `--help` output.
...
See [references/flashing-infrastructure.md](../raw/skills/hsb-flash/references/flashing-infrastructure.md) for GitHub release tags, bundled manifest YAML layout, board-specific flash commands, v2.0.0 CLI flag differences, and FPGA 2407 enumerate workaround.
...
See [references/phase-details.md](../raw/skills/hsb-flash/references/phase-details.md) for full step-by-step phase instructions, flashing procedure logic, execution rules, safety constraints, phase gate rules, verbosity behavior, force mode, and auto-approve mode.

## Built-in help (`--help`)

See [references/help-text.md](../raw/skills/hsb-flash/references/help-text.md) for the full `--help` output text.

## Invocation examples

See [references/help-text.md](../raw/skills/hsb-flash/references/help-text.md) for the full `--help` output including all invocation examples.
