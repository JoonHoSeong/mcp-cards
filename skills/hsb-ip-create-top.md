...
source: ../raw/skills/hsb-ip-create-top/SKILL.md
...
- **Skill ID:** `hsb-ip-create-top`
- **Purpose:** Create or explain fixed-format HSB FPGA_top.sv wrappers from validated HOLOLINK_def.svh files. Do not use for def generation or validation.
- **Canonical source:** [../raw/skills/hsb-ip-create-top/SKILL.md](../raw/skills/hsb-ip-create-top/SKILL.md)
