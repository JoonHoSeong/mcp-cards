...
source: ../raw/skills/hsb-ip-packetizer/SKILL.md
...
- **Skill ID:** `hsb-ip-packetizer`
- **Purpose:** Choose or explain HSB Sensor RX packetizer fields for HOLOLINK_def.svh. Do not use for full defs, validation, or runtime APB programming.
- **Canonical source:** [../raw/skills/hsb-ip-packetizer/SKILL.md](../raw/skills/hsb-ip-packetizer/SKILL.md)
