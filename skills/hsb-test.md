...
source: ../raw/skills/hsb-test/SKILL.md
...
- **Skill ID:** `hsb-test`
- **Purpose:** Execute QA test plans on Holoscan Sensor Bridge hardware. Reads a user-provided test document, filters tests by the user's setup, determines which tests can run automatically, executes them with pass/fail evaluation, and produces a structured test results report.
- **Canonical source:** [../raw/skills/hsb-test/SKILL.md](../raw/skills/hsb-test/SKILL.md)
...
See [references/phase-details.md](../raw/skills/hsb-test/references/phase-details.md) for full step-by-step phase instructions.
...
After every test run, stop and remove the container. See [references/phase-details.md](../raw/skills/hsb-test/references/phase-details.md) for the cleanup pattern.
