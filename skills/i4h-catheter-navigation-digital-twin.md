...
source: ../raw/skills/i4h-catheter-navigation-digital-twin/SKILL.md
...
- **Skill ID:** `i4h-catheter-navigation-digital-twin`
- **Purpose:** Build a patient vasculature digital twin from CT (preprocess + segment). Use when asked to preprocess CT, segment vessels, extract centerline, or prepare ct_cache for viewport/DRR.
- **Canonical source:** [../raw/skills/i4h-catheter-navigation-digital-twin/SKILL.md](../raw/skills/i4h-catheter-navigation-digital-twin/SKILL.md)
