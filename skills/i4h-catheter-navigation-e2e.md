...
source: ../raw/skills/i4h-catheter-navigation-e2e/SKILL.md
...
- **Skill ID:** `i4h-catheter-navigation-e2e`
- **Purpose:** End-to-end smoke for catheter navigation covering setup, digital twin, DRR, and unit tests. Use when asked to run the full catheter workflow smoke or demo the v0.7 pipeline.
- **Canonical source:** [../raw/skills/i4h-catheter-navigation-e2e/SKILL.md](../raw/skills/i4h-catheter-navigation-e2e/SKILL.md)
