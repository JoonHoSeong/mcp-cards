...
source: ../raw/skills/i4h-catheter-navigation-render-drr/SKILL.md
...
- **Skill ID:** `i4h-catheter-navigation-render-drr`
- **Purpose:** Render a single DRR fluoroscopy frame from a CT cache or synthetic phantom. Use when asked to render DRR, generate a fluoro image, or smoke-test the Slang renderer.
- **Canonical source:** [../raw/skills/i4h-catheter-navigation-render-drr/SKILL.md](../raw/skills/i4h-catheter-navigation-render-drr/SKILL.md)
