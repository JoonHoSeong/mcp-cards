...
source: ../raw/skills/i4h-catheter-navigation-smoke/SKILL.md
...
- **Skill ID:** `i4h-catheter-navigation-smoke`
- **Purpose:** Run CPU-only fluorosim smoke tests (imports, preprocessing, CLI parsers). Use when asked to smoke-test catheter navigation in CI or without a GPU.
- **Canonical source:** [../raw/skills/i4h-catheter-navigation-smoke/SKILL.md](../raw/skills/i4h-catheter-navigation-smoke/SKILL.md)
