...
source: ../raw/skills/i4h-catheter-navigation-viewport/SKILL.md
...
- **Skill ID:** `i4h-catheter-navigation-viewport`
- **Purpose:** Launch the interactive Slang fluoroscopy viewport with XPBD catheter physics. Use when asked to open the viewport, teleop a catheter, or demo fluoro navigation.
- **Canonical source:** [../raw/skills/i4h-catheter-navigation-viewport/SKILL.md](../raw/skills/i4h-catheter-navigation-viewport/SKILL.md)
