...
source: ../raw/skills/i4h-catheter-navigation/SKILL.md
...
- **Skill ID:** `i4h-catheter-navigation`
- **Purpose:** Overview of `workflows/catheter_navigation/` (fluorosim DRR, XPBD physics, vasculature digital twin). Use when the user asks what the catheter navigation workflow is, what's supported, or where to start.
- **Canonical source:** [../raw/skills/i4h-catheter-navigation/SKILL.md](../raw/skills/i4h-catheter-navigation/SKILL.md)
