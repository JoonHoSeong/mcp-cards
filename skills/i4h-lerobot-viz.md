...
source: ../raw/skills/i4h-lerobot-viz/SKILL.md
...
- **Skill ID:** `i4h-lerobot-viz`
- **Purpose:** Serve the LeRobot HTML visualizer for a converted dataset in a browser. Use when asked to visualize, inspect, or open a LeRobot dataset; not for converting HDF5 (use [[i4h-workflow-dataset-convert]]).
- **Canonical source:** [../raw/skills/i4h-lerobot-viz/SKILL.md](../raw/skills/i4h-lerobot-viz/SKILL.md)
