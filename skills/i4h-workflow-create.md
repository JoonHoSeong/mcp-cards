...
source: ../raw/skills/i4h-workflow-create/SKILL.md
...
- **Skill ID:** `i4h-workflow-create`
- **Purpose:** Create a new agentic env by forking an existing env. Use for new env/task scaffolding, not scene edits or baking.
- **Canonical source:** [../raw/skills/i4h-workflow-create/SKILL.md](../raw/skills/i4h-workflow-create/SKILL.md)
