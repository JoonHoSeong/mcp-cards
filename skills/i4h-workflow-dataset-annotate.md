...
source: ../raw/skills/i4h-workflow-dataset-annotate/SKILL.md
...
- **Skill ID:** `i4h-workflow-dataset-annotate`
- **Purpose:** Use a VLM to verify whether each episode satisfies the env's task description. Use when the user asks to annotate, label episodes, filter demos, or gate finetuning on a success classifier.
- **Canonical source:** [../raw/skills/i4h-workflow-dataset-annotate/SKILL.md](../raw/skills/i4h-workflow-dataset-annotate/SKILL.md)
