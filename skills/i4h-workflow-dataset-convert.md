...
source: ../raw/skills/i4h-workflow-dataset-convert/SKILL.md
...
- **Skill ID:** `i4h-workflow-dataset-convert`
- **Purpose:** Convert an agentic HDF5 recording into a LeRobot dataset (parquet, meta, videos). Use when asked to convert HDF5, prepare for training, or export to LeRobot; not for viewing — use [[i4h-lerobot-viz]].
- **Canonical source:** [../raw/skills/i4h-workflow-dataset-convert/SKILL.md](../raw/skills/i4h-workflow-dataset-convert/SKILL.md)
