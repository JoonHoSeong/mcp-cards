...
source: ../raw/skills/i4h-workflow-dataset-mimic/SKILL.md
...
- **Skill ID:** `i4h-workflow-dataset-mimic`
- **Purpose:** Expand an HDF5 recording by cloning trajectories with action/state noise. Use when asked to mimic, expand, or augment a dataset; not for recording new demos (use [[i4h-workflow-dataset-teleop]]).
- **Canonical source:** [../raw/skills/i4h-workflow-dataset-mimic/SKILL.md](../raw/skills/i4h-workflow-dataset-mimic/SKILL.md)
