...
source: ../raw/skills/i4h-workflow-dataset-replay/SKILL.md
...
- **Skill ID:** `i4h-workflow-dataset-replay`
- **Purpose:** Replay a recorded HDF5 episode inside Isaac Sim for visual verification. Use when the user asks to replay, play back, or step through an HDF5 recording.
- **Canonical source:** [../raw/skills/i4h-workflow-dataset-replay/SKILL.md](../raw/skills/i4h-workflow-dataset-replay/SKILL.md)
