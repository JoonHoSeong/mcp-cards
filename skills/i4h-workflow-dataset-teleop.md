...
source: ../raw/skills/i4h-workflow-dataset-teleop/SKILL.md
...
- **Skill ID:** `i4h-workflow-dataset-teleop`
- **Purpose:** Record episodes for an agentic env via teleoperation (keyboard, SO-ARM leader, or VR) into HDF5. Use when the user wants to teleop or record human demos.
- **Canonical source:** [../raw/skills/i4h-workflow-dataset-teleop/SKILL.md](../raw/skills/i4h-workflow-dataset-teleop/SKILL.md)
