...
source: ../raw/skills/i4h-workflow-e2e/SKILL.md
...
- **Skill ID:** `i4h-workflow-e2e`
- **Purpose:** Run the full end-to-end agentic pipeline (record → mimic → annotate → replay → convert → visualize → finetune → validate). Use when asked to run the whole pipeline or do an e2e, smoke, or demo run.
- **Canonical source:** [../raw/skills/i4h-workflow-e2e/SKILL.md](../raw/skills/i4h-workflow-e2e/SKILL.md)
