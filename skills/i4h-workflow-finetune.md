...
source: ../raw/skills/i4h-workflow-finetune/SKILL.md
...
- **Skill ID:** `i4h-workflow-finetune`
- **Purpose:** Fine-tune a GR00T or openpi PI0 policy on a LeRobot dataset. Use when asked to finetune, train, or post-train a policy on demos; not for evaluating a checkpoint (use [[i4h-workflow-validate]]).
- **Canonical source:** [../raw/skills/i4h-workflow-finetune/SKILL.md](../raw/skills/i4h-workflow-finetune/SKILL.md)
