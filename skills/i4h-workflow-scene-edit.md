...
source: ../raw/skills/i4h-workflow-scene-edit/SKILL.md
...
- **Skill ID:** `i4h-workflow-scene-edit`
- **Purpose:** Edit an env's scene in place — objects, cameras, task, success bounds, randomization. Use when asked to edit a scene or launch/run/open an env in edit mode (`--bridge`), incl. a just-created env.
- **Canonical source:** [../raw/skills/i4h-workflow-scene-edit/SKILL.md](../raw/skills/i4h-workflow-scene-edit/SKILL.md)
