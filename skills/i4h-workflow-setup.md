...
source: ../raw/skills/i4h-workflow-setup/SKILL.md
...
- **Skill ID:** `i4h-workflow-setup`
- **Purpose:** Verify host requirements and run `workflows/agentic/setup.sh`. Use when asked to set up, install, or bootstrap the agentic workflow, or hits missing `.venv`, third-party checkout, or engine errors.
- **Canonical source:** [../raw/skills/i4h-workflow-setup/SKILL.md](../raw/skills/i4h-workflow-setup/SKILL.md)
