...
source: ../raw/skills/i4h-workflow-validate/SKILL.md
...
- **Skill ID:** `i4h-workflow-validate`
- **Purpose:** Validate, evaluate, or run i4h envs. Use for policy/checkpoint rollouts and scripted state-machine smoke runs.
- **Canonical source:** [../raw/skills/i4h-workflow-validate/SKILL.md](../raw/skills/i4h-workflow-validate/SKILL.md)
