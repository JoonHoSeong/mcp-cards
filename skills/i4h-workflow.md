...
source: ../raw/skills/i4h-workflow/SKILL.md
...
- **Skill ID:** `i4h-workflow`
- **Purpose:** Overview of `workflows/agentic/` (IsaacLab-Arena + GR00T/openpi). Use when the user asks what i4h workflow is, what's supported, or where to start.
- **Canonical source:** [../raw/skills/i4h-workflow/SKILL.md](../raw/skills/i4h-workflow/SKILL.md)
