...
source: ../raw/skills/jetson-customize-fan/SKILL.md
...
- **Skill ID:** `jetson-customize-fan`
- **Purpose:** Use when you need to add, remove, edit, list, or change the boot default of an nvfancontrol fan profile on a Jetson/Tegra (Orin, Thor) target. Triggers: edit fan profile, tune fan curve.
- **Canonical source:** [../raw/skills/jetson-customize-fan/SKILL.md](../raw/skills/jetson-customize-fan/SKILL.md)
