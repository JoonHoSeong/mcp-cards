...
source: ../raw/skills/jetson-diagnostic/SKILL.md
...
- **Skill ID:** `jetson-diagnostic`
- **Purpose:** Read-only Jetson health snapshot for identity, memory, GPU, thermal, power, storage, services, and top processes.
- **Canonical source:** [../raw/skills/jetson-diagnostic/SKILL.md](../raw/skills/jetson-diagnostic/SKILL.md)
