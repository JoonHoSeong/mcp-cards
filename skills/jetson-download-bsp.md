...
source: ../raw/skills/jetson-download-bsp/SKILL.md
...
- **Skill ID:** `jetson-download-bsp`
- **Purpose:** Download NVIDIA Jetson Linux BSP artifacts (BSP tarball, sample rootfs, public_sources, x-tools, guides) for the active target. Use for Auto Setup; not for extraction or profile edits.
- **Canonical source:** [../raw/skills/jetson-download-bsp/SKILL.md](../raw/skills/jetson-download-bsp/SKILL.md)
...
[`User input prompt style`] (source reference not bundled),
...
- [`../../context/target-platform-contract.md`] (source reference not bundled)
- [`../jetson-quick-start/SKILL.md`](../raw/skills/jetson-quick-start/SKILL.md)
- [`../jetson-init-image/SKILL.md`](../raw/skills/jetson-init-image/SKILL.md)
- [`../jetson-init-source/SKILL.md`](../raw/skills/jetson-init-source/SKILL.md)
- [`../jetson-link-docs/SKILL.md`](../raw/skills/jetson-link-docs/SKILL.md)
