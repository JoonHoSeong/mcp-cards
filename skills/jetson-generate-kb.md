...
source: ../raw/skills/jetson-generate-kb/SKILL.md
...
- **Skill ID:** `jetson-generate-kb`
- **Purpose:** Build a per-target knowledge-base markdown next to the active profile by walking the BSP root and source tree. Use after init-image / init-source; not for editing profile fields.
- **Canonical source:** [../raw/skills/jetson-generate-kb/SKILL.md](../raw/skills/jetson-generate-kb/SKILL.md)
...
- [`../../context/target-platform-contract.md`] (source reference not bundled) — read-order contract this skill follows.
- [`../../context/bsp-customization-workflow.md`] (source reference not bundled) — origin of the canonical BSP/source subtree list.
- [`../../references/platform_template.yaml`] (source reference not bundled) — source of the documents-field one-line descriptions.
- [`../jetson-init-target/SKILL.md`](../raw/skills/jetson-init-target/SKILL.md) — sibling skill that authors the active target identity.
- [`../jetson-init-image/SKILL.md`](../raw/skills/jetson-init-image/SKILL.md) — sibling skill that authors the BSP image metadata this skill scans.
- [`../jetson-set-target/SKILL.md`](../raw/skills/jetson-set-target/SKILL.md) — sibling skill that flips the active pointer this skill resolves.
