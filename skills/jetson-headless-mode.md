...
source: ../raw/skills/jetson-headless-mode/SKILL.md
...
- **Skill ID:** `jetson-headless-mode`
- **Purpose:** Plan and apply safe Jetson headless-mode changes to reclaim GUI and daemon memory.
- **Canonical source:** [../raw/skills/jetson-headless-mode/SKILL.md](../raw/skills/jetson-headless-mode/SKILL.md)
