...
source: ../raw/skills/jetson-inference-mem-tune/SKILL.md
...
- **Skill ID:** `jetson-inference-mem-tune`
- **Purpose:** Pick the serving stack and per-runtime memory flags (vLLM, SGLang, llama.cpp, TensorRT Edge-LLM) for an LLM/VLM workload on any NVIDIA Jetson.
- **Canonical source:** [../raw/skills/jetson-inference-mem-tune/SKILL.md](../raw/skills/jetson-inference-mem-tune/SKILL.md)
