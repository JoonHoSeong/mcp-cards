...
source: ../raw/skills/jetson-init-image/SKILL.md
...
- **Skill ID:** `jetson-init-image`
- **Purpose:** Extract Jetson Linux + sample-rootfs tarballs and run apply_binaries.sh for the active target, then record bsp_image in the profile. Use after jetson-init-target; not for source-tree setup.
- **Canonical source:** [../raw/skills/jetson-init-image/SKILL.md](../raw/skills/jetson-init-image/SKILL.md)
...
- [`../jetson-init-target/SKILL.md`](../raw/skills/jetson-init-target/SKILL.md)
- [`../jetson-init-source/SKILL.md`](../raw/skills/jetson-init-source/SKILL.md)
- [`../jetson-flash-image/SKILL.md`](../raw/skills/jetson-flash-image/SKILL.md)
