...
source: ../raw/skills/jetson-init-source/SKILL.md
...
- **Skill ID:** `jetson-init-source`
- **Purpose:** Set up the BSP source workspace: Linux_for_Tegra overlay tracker, bsp_sources, Crosstool-NG toolchain. Use after jetson-init-image; not for fetching inputs.
- **Canonical source:** [../raw/skills/jetson-init-source/SKILL.md](../raw/skills/jetson-init-source/SKILL.md)
...
pristine commit). See
[`references/branch-a-extraction.md`](../raw/skills/jetson-init-source/references/branch-a-extraction.md)
...
- [`../../references/platform_template.yaml`] (source reference not bundled) — `source:` schema, including the `repos:` map.
...
- [`../jetson-init-target/SKILL.md`](../raw/skills/jetson-init-target/SKILL.md) — authors the profile this skill consumes.
- [`../jetson-init-image/SKILL.md`](../raw/skills/jetson-init-image/SKILL.md) — extracts the BSP and back-fills `bsp_image.version`; run before this skill.
