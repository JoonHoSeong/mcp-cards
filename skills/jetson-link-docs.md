...
source: ../raw/skills/jetson-link-docs/SKILL.md
...
- **Skill ID:** `jetson-link-docs`
- **Purpose:** Bind pre-downloaded Jetson reference docs (developer guide, design guide, pinmux, schematics) into the active profile documents block. Use after staging docs on disk; not for downloading.
- **Canonical source:** [../raw/skills/jetson-link-docs/SKILL.md](../raw/skills/jetson-link-docs/SKILL.md)
...
- [`../../context/target-platform-contract.md`] (source reference not bundled) — target-platform contract; this skill consumes and mutates the active profile.
- [`../../references/bsp-platforms-catalogue.md`] (source reference not bundled) — source of the **Product Token** column for the "Resolve the product token" step.
- [`../../references/platform_template.yaml`] (source reference not bundled) — schema for the `documents:` block (source of truth for prompts and field list).
- [`../jetson-init-target/SKILL.md`](../raw/skills/jetson-init-target/SKILL.md) — sibling skill that authors target identity (`reference_devkit:`, optional `custom_carrier:`).
- [`../jetson-init-image/SKILL.md`](../raw/skills/jetson-init-image/SKILL.md) — sibling skill that authors `bsp_image:`.
- [`../jetson-init-source/SKILL.md`](../raw/skills/jetson-init-source/SKILL.md) — sibling skill: clones shared repos and handles `source.root_path` overrides.
- [`../jetson-generate-kb/SKILL.md`](../raw/skills/jetson-generate-kb/SKILL.md) — sibling skill: consumes the `documents:` block this skill writes.
