...
source: ../raw/skills/jetson-llm-serve/SKILL.md
...
- **Skill ID:** `jetson-llm-serve`
- **Purpose:** Stand up vLLM or SGLang serving on Jetson, using upstream vLLM on Thor and Orin JetPack 7.2+, and NVIDIA-AI-IOT vLLM on older Orin.
- **Canonical source:** [../raw/skills/jetson-llm-serve/SKILL.md](../raw/skills/jetson-llm-serve/SKILL.md)
