...
source: ../raw/skills/jetson-memory-audit/SKILL.md
...
- **Skill ID:** `jetson-memory-audit`
- **Purpose:** Measure Jetson DRAM/NvMap usage and verify before/after memory reclamation with live audit data.
- **Canonical source:** [../raw/skills/jetson-memory-audit/SKILL.md](../raw/skills/jetson-memory-audit/SKILL.md)
