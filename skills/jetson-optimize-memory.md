...
source: ../raw/skills/jetson-optimize-memory/SKILL.md
...
- **Skill ID:** `jetson-optimize-memory`
- **Purpose:** Reclaim DRAM by disabling unused subsystems across MB1 BCT, MB2 BCT, kernel reserved-memory, and SWIOTLB. Use for headless or no-camera Jetson deployments; not for CPU/GPU frequency tuning.
- **Canonical source:** [../raw/skills/jetson-optimize-memory/SKILL.md](../raw/skills/jetson-optimize-memory/SKILL.md)
