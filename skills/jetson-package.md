...
source: ../raw/skills/jetson-package/SKILL.md
...
- **Skill ID:** `jetson-package`
- **Purpose:** Pick Jetson-compatible containers, vLLM runtime images, and Jetson AI Lab PyPI indexes; maps Orin SM 8.7 vs Thor SM 11.0 and JetPack-specific package choices.
- **Canonical source:** [../raw/skills/jetson-package/SKILL.md](../raw/skills/jetson-package/SKILL.md)
