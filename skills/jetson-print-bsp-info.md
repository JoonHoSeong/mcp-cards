...
source: ../raw/skills/jetson-print-bsp-info/SKILL.md
...
- **Skill ID:** `jetson-print-bsp-info`
- **Purpose:** Use when you need to print Jetson BSP info (L4T version, board configs, rootfs state) from a Linux_for_Tegra root on the host PC. This is an example skill.
- **Canonical source:** [../raw/skills/jetson-print-bsp-info/SKILL.md](../raw/skills/jetson-print-bsp-info/SKILL.md)
