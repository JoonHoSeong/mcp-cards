...
source: ../raw/skills/jetson-print-device-info/SKILL.md
...
- **Skill ID:** `jetson-print-device-info`
- **Purpose:** Use when you need to print Jetson device info (module model, L4T version, kernel, OS version, current power mode) from a running Jetson target. This is an example skill.
- **Canonical source:** [../raw/skills/jetson-print-device-info/SKILL.md](../raw/skills/jetson-print-device-info/SKILL.md)
