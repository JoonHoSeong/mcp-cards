...
source: ../raw/skills/jetson-speculative-decoding/SKILL.md
...
- **Skill ID:** `jetson-speculative-decoding`
- **Purpose:** Add EAGLE-3 or draft-model speculative decoding to a Jetson vLLM server when TPOT is the bottleneck.
- **Canonical source:** [../raw/skills/jetson-speculative-decoding/SKILL.md](../raw/skills/jetson-speculative-decoding/SKILL.md)
