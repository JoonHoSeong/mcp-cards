...
source: ../raw/skills/jetson-validate-image/SKILL.md
...
- **Skill ID:** `jetson-validate-image`
- **Purpose:** Use after jetson-flash-image to run static BSP checks, on-target smoke/regression tests on a flashed DUT, or both. Not for build or flash steps. Triggers: validate bsp, on-target validation.
- **Canonical source:** [../raw/skills/jetson-validate-image/SKILL.md](../raw/skills/jetson-validate-image/SKILL.md)
...
3. **Static checks** (if in scope):
     ...
     - **Initramfs ↔ kernel + rootfs module coherence.** Extract
       ...
       [the "Mirror kernel Image into rootfs" step](../raw/skills/jetson-promote-image/SKILL.md#mirror-kernel-image-into-rootfs-when-kernel-changed)
       ...
       [`../jetson-promote-image/SKILL.md`](../raw/skills/jetson-promote-image/SKILL.md#refresh-initramfs-when-kernel-or-modules-changed).
...
[`references/dut-access.md`](../raw/skills/jetson-validate-image/references/dut-access.md) to keep this
...
[`UART implementation contract`](../raw/skills/jetson-validate-image/references/dut-access.md#uart-implementation-contract).
...
- [`references/dut-access.md`](../raw/skills/jetson-validate-image/references/dut-access.md) — full DUT-access contract: profile schema, resolution order, probe, file transfer, sudo, UART implementation, security.
- [`../../context/target-platform-contract.md`] (source reference not bundled) — target-platform contract.
- [`../../context/bsp-customization-workflow.md`] (source reference not bundled) — Workspace edit protocol (this skill is the Deploy tail).
- [`../jetson-build-source/SKILL.md`](../raw/skills/jetson-build-source/SKILL.md) — Build builder; produces the artifacts this skill validates.
