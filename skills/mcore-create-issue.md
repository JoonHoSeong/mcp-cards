...
source: ../raw/skills/mcore-create-issue/SKILL.md
...
- **Skill ID:** `mcore-create-issue`
- **Purpose:** Investigate a failing GitHub Actions run or job and create a GitHub issue for the failure.
- **Canonical source:** [../raw/skills/mcore-create-issue/SKILL.md](../raw/skills/mcore-create-issue/SKILL.md)
...
CI test `<failed-test-node-id>` failed in job [`<job-name>`] (source reference not bundled).
...
| Field | Value |
|-------|-------|
| PR    | [#<pr_number>: <pr_title>] (source reference not bundled) |
| Run   | [<run_id>] (source reference not bundled) |
| Job   | [<job_name>] (source reference not bundled) |
