...
source: ../raw/skills/mcore-linting-and-formatting/SKILL.md
...
- **Skill ID:** `mcore-linting-and-formatting`
- **Purpose:** Linting and formatting for Megatron-LM. Covers running autoformat.sh, tools (ruff, black, isort, pylint, mypy), and code style rules.
- **Canonical source:** [../raw/skills/mcore-linting-and-formatting/SKILL.md](../raw/skills/mcore-linting-and-formatting/SKILL.md)
