...
source: ../raw/skills/mcore-split-pr/SKILL.md
...
- **Skill ID:** `mcore-split-pr`
- **Purpose:** Split a PR into multiple PRs to reduce the number of required CODEOWNERS reviewer groups.
- **Canonical source:** [../raw/skills/mcore-split-pr/SKILL.md](../raw/skills/mcore-split-pr/SKILL.md)
