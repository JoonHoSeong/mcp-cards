...
source: ../raw/skills/mcore-testing/SKILL.md
...
- **Skill ID:** `mcore-testing`
- **Purpose:** Test system for Megatron-LM. Covers test layout, recipe YAML structure, adding and running unit and functional tests, golden values, marker filters, and CI parity.
- **Canonical source:** [../raw/skills/mcore-testing/SKILL.md](../raw/skills/mcore-testing/SKILL.md)
