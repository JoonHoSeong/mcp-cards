...
source: ../raw/skills/nemo-data-designer-plugin/SKILL.md
...
- **Skill ID:** `nemo-data-designer-plugin`
- **Purpose:** Use when the user wants to create a dataset, generate synthetic data, or build a data generation pipeline.
- **Canonical source:** [../raw/skills/nemo-data-designer-plugin/SKILL.md](../raw/skills/nemo-data-designer-plugin/SKILL.md)
