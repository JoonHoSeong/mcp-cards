...
source: ../raw/skills/nemo-mbridge-mlm-bridge-training/SKILL.md
...
- **Skill ID:** `nemo-mbridge-mlm-bridge-training`
- **Purpose:** Run Megatron-LM (MLM) and Megatron Bridge training with mock or real data. Covers correlation testing, available recipes, and multi-GPU examples.
- **Canonical source:** [../raw/skills/nemo-mbridge-mlm-bridge-training/SKILL.md](../raw/skills/nemo-mbridge-mlm-bridge-training/SKILL.md)
