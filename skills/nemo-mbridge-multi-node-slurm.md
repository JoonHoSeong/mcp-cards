...
source: ../raw/skills/nemo-mbridge-multi-node-slurm/SKILL.md
...
- **Skill ID:** `nemo-mbridge-multi-node-slurm`
- **Purpose:** Convert single-node scripts to multi-node Slurm sbatch jobs and debug common multi-node failures. Covers srun-native vs uv run torch.distributed approaches, container setup, NCCL timeouts, OOM sizing for MoE models, and interactive allocation.
- **Canonical source:** [../raw/skills/nemo-mbridge-multi-node-slurm/SKILL.md](../raw/skills/nemo-mbridge-multi-node-slurm/SKILL.md)
...
[references/templates.md](../raw/skills/nemo-mbridge-multi-node-slurm/references/templates.md).
