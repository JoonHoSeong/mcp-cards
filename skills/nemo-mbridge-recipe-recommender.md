...
source: ../raw/skills/nemo-mbridge-recipe-recommender/SKILL.md
...
- **Skill ID:** `nemo-mbridge-recipe-recommender`
- **Purpose:** Recommend and customize Megatron Bridge recipes for a user's model, GPU count, and training goal. Indexes library recipes (pretrain/SFT/PEFT) and performance recipes.
- **Canonical source:** [../raw/skills/nemo-mbridge-recipe-recommender/SKILL.md](../raw/skills/nemo-mbridge-recipe-recommender/SKILL.md)
