...
source: ../raw/skills/nemo-mbridge-resiliency/SKILL.md
...
- **Skill ID:** `nemo-mbridge-resiliency`
- **Purpose:** Resiliency features in Megatron Bridge including fault tolerance, straggler detection, in-process restart, preemption, and re-run state machine.
- **Canonical source:** [../raw/skills/nemo-mbridge-resiliency/SKILL.md](../raw/skills/nemo-mbridge-resiliency/SKILL.md)
