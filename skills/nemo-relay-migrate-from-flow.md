...
source: ../raw/skills/nemo-relay-migrate-from-flow/SKILL.md
...
- **Skill ID:** `nemo-relay-migrate-from-flow`
- **Purpose:** Use this skill when migrating applications, examples, integrations, documentation, manifests, or repository code from NeMo Flow to NeMo Relay across Python, Rust, Node.js, Go, C FFI, CLI, configuration, and observability surfaces.
- **Canonical source:** [../raw/skills/nemo-relay-migrate-from-flow/SKILL.md](../raw/skills/nemo-relay-migrate-from-flow/SKILL.md)
