...
source: ../raw/skills/nemo-rl-docs/SKILL.md
...
- **Skill ID:** `nemo-rl-docs`
- **Purpose:** Documentation conventions for NeMo-RL. Covers docs/index.md updates and docstring format. Do NOT use for: bug fixes, test fixes, dependency bumps, refactoring, CI/CD changes, performance tuning, or any task that does not involve writing or updating documentation.
- **Canonical source:** [../raw/skills/nemo-rl-docs/SKILL.md](../raw/skills/nemo-rl-docs/SKILL.md)
