...
source: ../raw/skills/nemotron-policy-generator/SKILL.md
...
- **Skill ID:** `nemotron-policy-generator`
- **Purpose:** Generates BYO custom safety policies for NVIDIA Nemotron content-safety guardrails — Nemotron-Content-Safety-Reasoning-4B (text) and multimodal Nemotron-3-Content-Safety. Produces a Markdown policy, JSON taxonomy, and drop-in inference prompts. Maps rough words or an existing policy to V2 categories, adding custom categories or topic-following rules.
- **Canonical source:** [../raw/skills/nemotron-policy-generator/SKILL.md](../raw/skills/nemotron-policy-generator/SKILL.md)
