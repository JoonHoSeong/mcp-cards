...
source: ../raw/skills/nemotron-retrieval-recipes/SKILL.md
...
- **Skill ID:** `nemotron-retrieval-recipes`
- **Purpose:** Use when planning, debugging, tuning, evaluating, exporting, or deploying public Nemotron `embed`/`rerank` retrieval recipes.
- **Canonical source:** [../raw/skills/nemotron-retrieval-recipes/SKILL.md](../raw/skills/nemotron-retrieval-recipes/SKILL.md)
