...
source: ../raw/skills/nemotron-speech/SKILL.md
...
- **Skill ID:** `nemotron-speech`
- **Purpose:** Routes NVIDIA Nemotron Speech (Riva) NIM tasks — deploys, runs, and tests ASR, TTS, and NMT NIMs on build.nvidia.com or self-hosted.
- **Canonical source:** [../raw/skills/nemotron-speech/SKILL.md](../raw/skills/nemotron-speech/SKILL.md)
...
- For **self-hosted deployment**: NVIDIA AI Enterprise (NVAIE) entitlement, then complete the environment setup — NVIDIA drivers, Docker, Container Toolkit, NGC API key, Riva Python client. See [`references/setup.md`](../raw/skills/nemotron-speech/references/setup.md).
...
- Route setup requests for drivers, Docker, Container Toolkit, and NGC to [`references/setup.md`](../raw/skills/nemotron-speech/references/setup.md).
- Route GPU compatibility, deployment readiness, and container health checks to [`references/deployment-readiness-checks.md`](../raw/skills/nemotron-speech/references/deployment-readiness-checks.md).
- Route model choice across ASR, TTS, and NMT to [`references/model-selection.md`](../raw/skills/nemotron-speech/references/model-selection.md).
- Route ASR deployment or inference for Parakeet, Canary, Whisper, and Nemotron ASR Streaming to [`references/asr.md`](../raw/skills/nemotron-speech/references/asr.md).
- Route custom-trained NeMo ASR deployment (`.nemo` → RMIR → NIM) to [`references/asr-custom.md`](../raw/skills/nemotron-speech/references/asr-custom.md).
- Route ASR pipeline configuration for VAD, diarization, language models, and chunk size to [`references/pipelines.md`](../raw/skills/nemotron-speech/references/pipelines.md).
- Route TTS deployment or inference for Magpie to [`references/tts.md`](../raw/skills/nemotron-speech/references/tts.md).
- Route NMT deployment or inference for Riva Translate, language pairs, and DNT tags to [`references/nmt.md`](../raw/skills/nemotron-speech/references/nmt.md).
...
**"Deploy a Parakeet ASR NIM"** → load [`references/asr.md`](../raw/skills/nemotron-speech/references/asr.md), follow Option B (self-hosted), Steps 1–4.

**"Synthesize speech with Magpie"** → load [`references/tts.md`](../raw/skills/nemotron-speech/references/tts.md), follow Option A (cloud) or Option B (self-hosted).

**"Translate English to German"** → load [`references/nmt.md`](../raw/skills/nemotron-speech/references/nmt.md), follow the 4-step flow.

**"Convert my fine-tuned `.nemo` to a NIM"** → load [`references/asr-custom.md`](../raw/skills/nemotron-speech/references/asr-custom.md) for the 4-phase pipeline and [`references/pipelines.md`](../raw/skills/nemotron-speech/references/pipelines.md) for build-time config.

**"Can my GPU run this?"** → load [`references/deployment-readiness-checks.md`](../raw/skills/nemotron-speech/references/deployment-readiness-checks.md) and run the 6-step system check.

**"Which Riva model should I use?"** → load [`references/model-selection.md`](../raw/skills/nemotron-speech/references/model-selection.md), apply the decision framework, then fetch the support matrix for the specific current model name.
...
- **Container does not become ready** → [`references/deployment-readiness-checks.md`](../raw/skills/nemotron-speech/references/deployment-readiness-checks.md) (system check + health check table)
- **Health check fails** → [`references/deployment-readiness-checks.md`](../raw/skills/nemotron-speech/references/deployment-readiness-checks.md)
- **`docker pull` from `nvcr.io` returns 403** → [`references/setup.md`](../raw/skills/nemotron-speech/references/setup.md) (Step 5 — Docker login)
- **Wrong base image / model architecture mismatch** → [`references/asr-custom.md`](../raw/skills/nemotron-speech/references/asr-custom.md) (Phase 2 base image)
- **VRAM / GPU compatibility** → [`references/deployment-readiness-checks.md`](../raw/skills/nemotron-speech/references/deployment-readiness-checks.md), then verify on the support matrix

## Limitations

- x86_64 architecture only — WSL2 on Windows requires Podman and supports a subset of NIMs (see [`references/setup.md`](../raw/skills/nemotron-speech/references/setup.md))
...
- Verify hardware compatibility: [`references/deployment-readiness-checks.md`](../raw/skills/nemotron-speech/references/deployment-readiness-checks.md)
- Set up the environment: [`references/setup.md`](../raw/skills/nemotron-speech/references/setup.md)
- Pick a model: [`references/model-selection.md`](../raw/skills/nemotron-speech/references/model-selection.md)
- Deploy: [`references/asr.md`](../raw/skills/nemotron-speech/references/asr.md), [`references/tts.md`](../raw/skills/nemotron-speech/references/tts.md), or [`references/nmt.md`](../raw/skills/nemotron-speech/references/nmt.md)
