...
source: ../raw/skills/nv-generate-mr-brain-finetune/SKILL.md
...
- **Skill ID:** `nv-generate-mr-brain-finetune`
- **Purpose:** Used for finetuning NV-Generate-CTMR MR-brain diffusion UNet from a NIfTI datalist. Not for clinical or production data approval.
- **Canonical source:** [../raw/skills/nv-generate-mr-brain-finetune/SKILL.md](../raw/skills/nv-generate-mr-brain-finetune/SKILL.md)
...
- Point the [`nv-generate-mr-brain`](../raw/skills/nv-generate-mr-brain/SKILL.md) inference skill at the finetuned checkpoint to generate fresh brain MRI volumes for qualitative review.
