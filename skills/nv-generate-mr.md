...
source: ../raw/skills/nv-generate-mr/SKILL.md
...
- **Skill ID:** `nv-generate-mr`
- **Purpose:** Used for generating synthetic body MRI volumes with NV-Generate-CTMR rflow-mr. Not for paired masks or production training data.
- **Canonical source:** [../raw/skills/nv-generate-mr/SKILL.md](../raw/skills/nv-generate-mr/SKILL.md)
