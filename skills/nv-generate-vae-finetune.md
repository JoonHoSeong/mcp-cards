...
source: ../raw/skills/nv-generate-vae-finetune/SKILL.md
...
- **Skill ID:** `nv-generate-vae-finetune`
- **Purpose:** Used for finetuning the NV-Generate-CTMR MAISI VAE from CT/MRI NIfTI datalists. Not for clinical or production data approval.
- **Canonical source:** [../raw/skills/nv-generate-vae-finetune/SKILL.md](../raw/skills/nv-generate-vae-finetune/SKILL.md)
...
- Plug the finetuned autoencoder into a diffusion finetune/generation run (e.g. [`nv-generate-mr-brain-finetune`](../raw/skills/nv-generate-mr-brain-finetune/SKILL.md) via `--trained-autoencoder-path`) to confirm latents still decode to usable volumes.
