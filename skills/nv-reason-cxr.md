...
source: ../raw/skills/nv-reason-cxr/SKILL.md
...
- **Skill ID:** `nv-reason-cxr`
- **Purpose:** Used for command-shape or live NV-Reason-CXR chest X-ray reasoning smoke tests. Not for diagnosis or clinical reporting.
- **Canonical source:** [../raw/skills/nv-reason-cxr/SKILL.md](../raw/skills/nv-reason-cxr/SKILL.md)
