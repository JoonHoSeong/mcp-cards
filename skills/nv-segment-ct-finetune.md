...
source: ../raw/skills/nv-segment-ct-finetune/SKILL.md
...
- **Skill ID:** `nv-segment-ct-finetune`
- **Purpose:** Used for smoke or dataset finetuning of NV-Segment-CT VISTA3D on CT NIfTI labels. Not for clinical validation.
- **Canonical source:** [../raw/skills/nv-segment-ct-finetune/SKILL.md](../raw/skills/nv-segment-ct-finetune/SKILL.md)
