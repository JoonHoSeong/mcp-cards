...
source: ../raw/skills/nv-segment-ct/SKILL.md
...
- **Skill ID:** `nv-segment-ct`
- **Purpose:** Used for running NV-Segment-CT VISTA3D on CT NIfTI volumes and recording label-map evidence.
- **Canonical source:** [../raw/skills/nv-segment-ct/SKILL.md](../raw/skills/nv-segment-ct/SKILL.md)
