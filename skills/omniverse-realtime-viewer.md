...
source: ../raw/skills/omniverse-realtime-viewer/SKILL.md
...
- **Skill ID:** `omniverse-realtime-viewer`
- **Purpose:** Use as the top-level router for Omniverse Realtime Viewer USD app requests and focused viewer reference documents.
- **Canonical source:** [../raw/skills/omniverse-realtime-viewer/SKILL.md](../raw/skills/omniverse-realtime-viewer/SKILL.md)
