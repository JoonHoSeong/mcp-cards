...
source: ../raw/skills/physical-ai-video-data-augmentation/SKILL.md
...
- **Skill ID:** `physical-ai-video-data-augmentation`
- **Purpose:** Use when running video data augmentation and auto-labeling workflows on OSMO: flow selection, preflight, submit-time interpolation, monitoring, and output retrieval. Trigger keywords: video data augmentation, data enrichment, auto labeling, VDA demo, OSMO workflow, pseudo labeling.
- **Canonical source:** [../raw/skills/physical-ai-video-data-augmentation/SKILL.md](../raw/skills/physical-ai-video-data-augmentation/SKILL.md)
