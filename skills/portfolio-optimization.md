...
source: ../raw/skills/portfolio-optimization/SKILL.md
...
- **Skill ID:** `portfolio-optimization`
- **Purpose:** Use when a user asks to build, optimize, backtest, rebalance, or analyze a stock portfolio with Mean-CVaR, Mean-Variance/SOCP variance caps, efficient frontiers, scenario generation, or NVIDIA cuOpt.
- **Canonical source:** [../raw/skills/portfolio-optimization/SKILL.md](../raw/skills/portfolio-optimization/SKILL.md)
