...
source: ../raw/skills/tao-finetune-clip/SKILL.md
...
- **Skill ID:** `tao-finetune-clip`
- **Purpose:** CLIP vision-language model for image-text retrieval, zero-shot classification, embedding extraction, ONNX
- **Canonical source:** [../raw/skills/tao-finetune-clip/SKILL.md](../raw/skills/tao-finetune-clip/SKILL.md)
...
- [tao-deploy-clip](../raw/skills/tao-finetune-clip/references/tao-deploy-clip.md)
