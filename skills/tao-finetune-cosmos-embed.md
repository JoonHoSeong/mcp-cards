...
source: ../raw/skills/tao-finetune-cosmos-embed/SKILL.md
...
- **Skill ID:** `tao-finetune-cosmos-embed`
- **Purpose:** Cosmos-Embed1 video-text embedding for text-to-video retrieval, video-to-video search, semantic deduplication, and fine-tuning. Use when the user asks to "fine-tune Cosmos-Embed1", "run cosmos-embed inference", "export Cosmos-Embed1", "embed videos", or "search videos with text".
- **Canonical source:** [../raw/skills/tao-finetune-cosmos-embed/SKILL.md](../raw/skills/tao-finetune-cosmos-embed/SKILL.md)
