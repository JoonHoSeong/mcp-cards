...
source: ../raw/skills/tao-finetune-cosmos-reason/SKILL.md
...
- **Skill ID:** `tao-finetune-cosmos-reason`
- **Purpose:** Cosmos3-Nano video QA supervised fine-tuning with FSDP parallelism. Use when training or evaluating video
- **Canonical source:** [../raw/skills/tao-finetune-cosmos-reason/SKILL.md](../raw/skills/tao-finetune-cosmos-reason/SKILL.md)
