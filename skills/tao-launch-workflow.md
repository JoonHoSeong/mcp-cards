...
source: ../raw/skills/tao-launch-workflow/SKILL.md
...
- **Skill ID:** `tao-launch-workflow`
- **Purpose:** Shared launch intake for any TAO workflow or action. Use when the user wants to run TAO AutoML, train, evaluate, infer, export, generate TensorRT engines, or launch DEFT/workflow jobs on an execution platform.
- **Canonical source:** [../raw/skills/tao-launch-workflow/SKILL.md](../raw/skills/tao-launch-workflow/SKILL.md)
