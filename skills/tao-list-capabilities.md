...
source: ../raw/skills/tao-list-capabilities/SKILL.md
...
- **Skill ID:** `tao-list-capabilities`
- **Purpose:** Answer what the TAO Skill Bank plugin can do by generating the response from packaged application, data, model, AutoML, and platform manifests. Use when the user asks "what can TAO Skill Bank do", "list TAO models", "which TAO workflows are available", or "what supports AutoML".
- **Canonical source:** [../raw/skills/tao-list-capabilities/SKILL.md](../raw/skills/tao-list-capabilities/SKILL.md)
