...
source: ../raw/skills/tao-port-huggingface-model/SKILL.md
...
- **Skill ID:** `tao-port-huggingface-model`
- **Purpose:** Integrate a HuggingFace Computer Vision model into the NVIDIA TAO Toolkit ecosystem (tao-core config, tao-pytorch trainer, tao-deploy TensorRT pipeline). Use when the user asks to "integrate a HuggingFace model into TAO", "add an HF model to TAO Toolkit", "wire a HuggingFace ViT/DETR/ SegFormer into tao-pytorch", "build a TAO trainer + deploy pipeline for an HF CV model", or pastes a HuggingFace model URL/ID and wants it turned into a TAO model. Covers the full 7-phase loop: prerequisites check, HuggingFace inspection and validation, codebase exploration, tao-core configuration and native trainer implementation, ONNX export plus TensorRT deploy integration, packaging and L0 testing, container-based end-to-end validation, and (conditional) accuracy/latency tuning. Supports classification, object detection, semantic / instance / panoptic segmentation, zero-shot detection, and depth estimation.
- **Canonical source:** [../raw/skills/tao-port-huggingface-model/SKILL.md](../raw/skills/tao-port-huggingface-model/SKILL.md)
...
|---|---|---|
| 0 | Prerequisites + TAO Toolkit images + local image tags | [phase-0-prereqs.md](../raw/skills/tao-port-huggingface-model/references/phase-0-prereqs.md) |
| 1 | Inputs, HF-inspection container, validate model + dataset | [phase-1-inspection.md](../raw/skills/tao-port-huggingface-model/references/phase-1-inspection.md), [hf-inspection.md](../raw/skills/tao-port-huggingface-model/references/hf-inspection.md) |
| 2 | Closest existing TAO reference model | [phase-2-codebase.md](../raw/skills/tao-port-huggingface-model/references/phase-2-codebase.md), [task-type-guide.md](../raw/skills/tao-port-huggingface-model/references/task-type-guide.md) |
| 3 | tao-core config + tao-pytorch trainer / eval / inference | [phase-3-implementation.md](../raw/skills/tao-port-huggingface-model/references/phase-3-implementation.md), [tao-patterns.md](../raw/skills/tao-port-huggingface-model/references/tao-patterns.md), [repo-structure.md](../raw/skills/tao-port-huggingface-model/references/repo-structure.md) |
| 4 | ONNX export + tao-deploy TRT engine / inference / eval | [phase-4-deploy.md](../raw/skills/tao-port-huggingface-model/references/phase-4-deploy.md) |
| 5 | Packaging (`console_scripts`) + L0 tests | [phase-5-packaging.md](../raw/skills/tao-port-huggingface-model/references/phase-5-packaging.md) |
| 6 | Container testing + end-to-end validation | [phase-6-container-tests.md](../raw/skills/tao-port-huggingface-model/references/phase-6-container-tests.md), [docker-patterns.md](../raw/skills/tao-port-huggingface-model/references/docker-patterns.md) |
| 7 | (conditional) Accuracy / latency / size tuning | [phase-7-optimization.md](../raw/skills/tao-port-huggingface-model/references/phase-7-optimization.md) |

Cross-cutting refs: [workflow-consistency.md](../raw/skills/tao-port-huggingface-model/references/workflow-consistency.md) (CLI flow, config field paths, cross-phase dependencies); [cross-cutting.md](../raw/skills/tao-port-huggingface-model/references/cross-cutting.md) (platform, isolation, module pitfalls, debugging).
