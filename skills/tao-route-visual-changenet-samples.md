...
source: ../raw/skills/tao-route-visual-changenet-samples/SKILL.md
...
- **Skill ID:** `tao-route-visual-changenet-samples`
- **Purpose:** Routes the weakest VCN samples (output of `tao-analyze-gaps-visual-changenet`) into per-augmentation-module
- **Canonical source:** [../raw/skills/tao-route-visual-changenet-samples/SKILL.md](../raw/skills/tao-route-visual-changenet-samples/SKILL.md)
