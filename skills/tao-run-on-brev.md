...
source: ../raw/skills/tao-run-on-brev/SKILL.md
...
- **Skill ID:** `tao-run-on-brev`
- **Purpose:** Brev managed GPU instances with Docker support. Use when running TAO training, evaluation, or inference on
- **Canonical source:** [../raw/skills/tao-run-on-brev/SKILL.md](../raw/skills/tao-run-on-brev/SKILL.md)
