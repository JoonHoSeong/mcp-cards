...
source: ../raw/skills/tao-run-on-docker/SKILL.md
...
- **Skill ID:** `tao-run-on-docker`
- **Purpose:** Docker conventions for running NVIDIA GPU container workloads — NGC authentication, --gpus flag, mount patterns,
- **Canonical source:** [../raw/skills/tao-run-on-docker/SKILL.md](../raw/skills/tao-run-on-docker/SKILL.md)
