...
source: ../raw/skills/tao-run-on-kubernetes/SKILL.md
...
- **Skill ID:** `tao-run-on-kubernetes`
- **Purpose:** Kubernetes execution platform — submits TAO container jobs as single-pod k8s Jobs with NVIDIA GPU scheduling.
- **Canonical source:** [../raw/skills/tao-run-on-kubernetes/SKILL.md](../raw/skills/tao-run-on-kubernetes/SKILL.md)
