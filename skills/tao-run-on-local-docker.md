...
source: ../raw/skills/tao-run-on-local-docker/SKILL.md
...
- **Skill ID:** `tao-run-on-local-docker`
- **Purpose:** Local or remote Docker execution for TAO SDK job containers using a Docker daemon with NVIDIA GPU runtime. Use
- **Canonical source:** [../raw/skills/tao-run-on-local-docker/SKILL.md](../raw/skills/tao-run-on-local-docker/SKILL.md)
