...
source: ../raw/skills/tao-run-on-slurm/SKILL.md
...
- **Skill ID:** `tao-run-on-slurm`
- **Purpose:** Remote SLURM GPU cluster execution over SSH with sbatch/srun, Pyxis/Enroot containers, and Lustre-backed
- **Canonical source:** [../raw/skills/tao-run-on-slurm/SKILL.md](../raw/skills/tao-run-on-slurm/SKILL.md)
