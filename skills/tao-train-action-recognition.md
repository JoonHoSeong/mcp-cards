...
source: ../raw/skills/tao-train-action-recognition/SKILL.md
...
- **Skill ID:** `tao-train-action-recognition`
- **Purpose:** Action recognition from video sequences. Supports RGB, optical flow, and joint (multi-stream) input types for
- **Canonical source:** [../raw/skills/tao-train-action-recognition/SKILL.md](../raw/skills/tao-train-action-recognition/SKILL.md)
