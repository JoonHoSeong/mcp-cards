...
source: ../raw/skills/tao-train-deformable-detr/SKILL.md
...
- **Skill ID:** `tao-train-deformable-detr`
- **Purpose:** Deformable DETR for 2D object detection. Uses deformable attention for efficient multi-scale feature processing,
- **Canonical source:** [../raw/skills/tao-train-deformable-detr/SKILL.md](../raw/skills/tao-train-deformable-detr/SKILL.md)
...
- [tao-deploy-deformable-detr](../raw/skills/tao-train-deformable-detr/references/tao-deploy-deformable-detr.md)
