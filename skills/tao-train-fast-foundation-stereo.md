...
source: ../raw/skills/tao-train-fast-foundation-stereo/SKILL.md
...
- **Skill ID:** `tao-train-fast-foundation-stereo`
- **Purpose:** Real-time stereo depth estimation using FastFoundationStereo (FFS), the distilled bp2 commercial variant of
- **Canonical source:** [../raw/skills/tao-train-fast-foundation-stereo/SKILL.md](../raw/skills/tao-train-fast-foundation-stereo/SKILL.md)
...
- [tao-deploy-fast-foundation-stereo](../raw/skills/tao-train-fast-foundation-stereo/references/tao-deploy-fast-foundation-stereo.md)
