...
source: ../raw/skills/tao-train-foundation-stereo/SKILL.md
...
- **Skill ID:** `tao-train-foundation-stereo`
- **Purpose:** Stereo depth estimation using FoundationStereo. Predicts disparity maps from stereo image pairs for 3D
- **Canonical source:** [../raw/skills/tao-train-foundation-stereo/SKILL.md](../raw/skills/tao-train-foundation-stereo/SKILL.md)
...
- [tao-deploy-foundation-stereo](../raw/skills/tao-train-foundation-stereo/references/tao-deploy-foundation-stereo.md)
