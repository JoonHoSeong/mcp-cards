...
source: ../raw/skills/tao-train-grounding-dino/SKILL.md
...
- **Skill ID:** `tao-train-grounding-dino`
- **Purpose:** Grounding DINO for open-set object detection. Combines DINO-style detection with a BERT text encoder for
- **Canonical source:** [../raw/skills/tao-train-grounding-dino/SKILL.md](../raw/skills/tao-train-grounding-dino/SKILL.md)
...
- [tao-deploy-grounding-dino](../raw/skills/tao-train-grounding-dino/references/tao-deploy-grounding-dino.md)
