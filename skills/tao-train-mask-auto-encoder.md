...
source: ../raw/skills/tao-train-mask-auto-encoder/SKILL.md
...
- **Skill ID:** `tao-train-mask-auto-encoder`
- **Purpose:** Masked Auto-Encoder (MAE) for self-supervised pretraining and fine-tuning. Masks random patches and reconstructs
- **Canonical source:** [../raw/skills/tao-train-mask-auto-encoder/SKILL.md](../raw/skills/tao-train-mask-auto-encoder/SKILL.md)
...
- [tao-deploy-mask-auto-encoder](../raw/skills/tao-train-mask-auto-encoder/references/tao-deploy-mask-auto-encoder.md)
