...
source: ../raw/skills/tao-train-mask-auto-label/SKILL.md
...
- **Skill ID:** `tao-train-mask-auto-label`
- **Purpose:** MAL (Mask Auto-Label) for weakly-supervised segmentation. Produces segmentation masks from minimal annotations
- **Canonical source:** [../raw/skills/tao-train-mask-auto-label/SKILL.md](../raw/skills/tao-train-mask-auto-label/SKILL.md)
