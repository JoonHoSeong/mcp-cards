...
source: ../raw/skills/tao-train-mask-grounding-dino/SKILL.md
...
- **Skill ID:** `tao-train-mask-grounding-dino`
- **Purpose:** Mask Grounding DINO for grounded instance segmentation. Extends Grounding DINO with a mask-prediction head for
- **Canonical source:** [../raw/skills/tao-train-mask-grounding-dino/SKILL.md](../raw/skills/tao-train-mask-grounding-dino/SKILL.md)
...
- [tao-deploy-mask-grounding-dino](../raw/skills/tao-train-mask-grounding-dino/references/tao-deploy-mask-grounding-dino.md)
