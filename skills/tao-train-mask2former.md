...
source: ../raw/skills/tao-train-mask2former/SKILL.md
...
- **Skill ID:** `tao-train-mask2former`
- **Purpose:** Mask2Former for universal image segmentation (panoptic, instance, and semantic). Transformer-based with
- **Canonical source:** [../raw/skills/tao-train-mask2former/SKILL.md](../raw/skills/tao-train-mask2former/SKILL.md)
...
- [tao-deploy-mask2former](../raw/skills/tao-train-mask2former/references/tao-deploy-mask2former.md)
