...
source: ../raw/skills/tao-train-metric-learning-recognition/SKILL.md
...
- **Skill ID:** `tao-train-metric-learning-recognition`
- **Purpose:** Metric-learning recognition (ml-recog) for fine-grained visual recognition. Learns embeddings for
- **Canonical source:** [../raw/skills/tao-train-metric-learning-recognition/SKILL.md](../raw/skills/tao-train-metric-learning-recognition/SKILL.md)
...
- [tao-deploy-metric-learning-recognition](../raw/skills/tao-train-metric-learning-recognition/references/tao-deploy-metric-learning-recognition.md)
