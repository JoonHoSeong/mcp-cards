...
source: ../raw/skills/tao-train-nvdinov2/SKILL.md
...
- **Skill ID:** `tao-train-nvdinov2`
- **Purpose:** NVDINOv2 for self-supervised visual representation learning. Trains vision transformers via self-distillation
- **Canonical source:** [../raw/skills/tao-train-nvdinov2/SKILL.md](../raw/skills/tao-train-nvdinov2/SKILL.md)
...
- [tao-deploy-nvdinov2](../raw/skills/tao-train-nvdinov2/references/tao-deploy-nvdinov2.md)
