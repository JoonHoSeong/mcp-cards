...
source: ../raw/skills/tao-train-ocdnet/SKILL.md
...
- **Skill ID:** `tao-train-ocdnet`
- **Purpose:** OCDNet for scene text detection. Detects arbitrary-oriented text regions in natural images using a
- **Canonical source:** [../raw/skills/tao-train-ocdnet/SKILL.md](../raw/skills/tao-train-ocdnet/SKILL.md)
...
- [tao-deploy-ocdnet](../raw/skills/tao-train-ocdnet/references/tao-deploy-ocdnet.md)
