...
source: ../raw/skills/tao-train-ocrnet/SKILL.md
...
- **Skill ID:** `tao-train-ocrnet`
- **Purpose:** OCRNet for scene text recognition. Recognizes text content from cropped text-region images and supports CTC
- **Canonical source:** [../raw/skills/tao-train-ocrnet/SKILL.md](../raw/skills/tao-train-ocrnet/SKILL.md)
...
- [tao-deploy-ocrnet](../raw/skills/tao-train-ocrnet/references/tao-deploy-ocrnet.md)
