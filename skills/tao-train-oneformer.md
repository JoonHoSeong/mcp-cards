...
source: ../raw/skills/tao-train-oneformer/SKILL.md
...
- **Skill ID:** `tao-train-oneformer`
- **Purpose:** OneFormer for universal image segmentation. Unifies panoptic, instance, and semantic segmentation with a
- **Canonical source:** [../raw/skills/tao-train-oneformer/SKILL.md](../raw/skills/tao-train-oneformer/SKILL.md)
...
- [tao-deploy-oneformer](../raw/skills/tao-train-oneformer/references/tao-deploy-oneformer.md)
