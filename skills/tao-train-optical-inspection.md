...
source: ../raw/skills/tao-train-optical-inspection/SKILL.md
...
- **Skill ID:** `tao-train-optical-inspection`
- **Purpose:** Optical Inspection for defect detection using Siamese networks. Compares image pairs to detect manufacturing
- **Canonical source:** [../raw/skills/tao-train-optical-inspection/SKILL.md](../raw/skills/tao-train-optical-inspection/SKILL.md)
...
- [tao-deploy-optical-inspection](../raw/skills/tao-train-optical-inspection/references/tao-deploy-optical-inspection.md)
