...
source: ../raw/skills/tao-train-pointpillars/SKILL.md
...
- **Skill ID:** `tao-train-pointpillars`
- **Purpose:** PointPillars for 3D object detection from LiDAR point clouds. Encodes point clouds into a pseudo-image via a
- **Canonical source:** [../raw/skills/tao-train-pointpillars/SKILL.md](../raw/skills/tao-train-pointpillars/SKILL.md)
...
- [tao-deploy-pointpillars](../raw/skills/tao-train-pointpillars/references/tao-deploy-pointpillars.md)
