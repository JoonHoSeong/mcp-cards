...
source: ../raw/skills/tao-train-pose-classification/SKILL.md
...
- **Skill ID:** `tao-train-pose-classification`
- **Purpose:** Pose classification using ST-GCN (Spatial Temporal Graph Convolutional Network). Classifies skeleton sequences
- **Canonical source:** [../raw/skills/tao-train-pose-classification/SKILL.md](../raw/skills/tao-train-pose-classification/SKILL.md)
