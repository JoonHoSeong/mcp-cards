...
source: ../raw/skills/tao-train-reid/SKILL.md
...
- **Skill ID:** `tao-train-reid`
- **Purpose:** Person re-identification (ReID). Learns discriminative embeddings to match the same person across different
- **Canonical source:** [../raw/skills/tao-train-reid/SKILL.md](../raw/skills/tao-train-reid/SKILL.md)
