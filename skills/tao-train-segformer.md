...
source: ../raw/skills/tao-train-segformer/SKILL.md
...
- **Skill ID:** `tao-train-segformer`
- **Purpose:** SegFormer for semantic segmentation. Lightweight transformer-based architecture with hierarchical feature
- **Canonical source:** [../raw/skills/tao-train-segformer/SKILL.md](../raw/skills/tao-train-segformer/SKILL.md)
...
- [tao-deploy-segformer](../raw/skills/tao-train-segformer/references/tao-deploy-segformer.md)
