...
source: ../raw/skills/tao-train-single-step/SKILL.md
...
- **Skill ID:** `tao-train-single-step`
- **Purpose:** Standard single-step train/eval/export workflow for any TAO model. Use when training a TAO model on a dataset
- **Canonical source:** [../raw/skills/tao-train-single-step/SKILL.md](../raw/skills/tao-train-single-step/SKILL.md)
