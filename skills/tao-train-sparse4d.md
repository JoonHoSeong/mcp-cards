...
source: ../raw/skills/tao-train-sparse4d/SKILL.md
...
- **Skill ID:** `tao-train-sparse4d`
- **Purpose:** Sparse4D for multi-camera temporal 3D object detection and tracking. Uses sparse queries with deformable
- **Canonical source:** [../raw/skills/tao-train-sparse4d/SKILL.md](../raw/skills/tao-train-sparse4d/SKILL.md)
