...
source: ../raw/skills/tao-train-visual-changenet/SKILL.md
...
- **Skill ID:** `tao-train-visual-changenet`
- **Purpose:** Visual ChangeNet for binary image classification and segmentation in AOI defect detection. Use when training,
- **Canonical source:** [../raw/skills/tao-train-visual-changenet/SKILL.md](../raw/skills/tao-train-visual-changenet/SKILL.md)
...
- [tao-deploy-visual-changenet](../raw/skills/tao-train-visual-changenet/references/tao-deploy-visual-changenet.md)
