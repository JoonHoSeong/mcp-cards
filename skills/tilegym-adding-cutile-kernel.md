...
source: ../raw/skills/tilegym-adding-cutile-kernel/SKILL.md
...
- **Skill ID:** `tilegym-adding-cutile-kernel`
- **Purpose:** Add a new cuTile GPU kernel operator to TileGym. Covers dispatch registration in ops.py, cuTile backend implementation, __init__.py exports, test creation, and benchmark in tests/benchmark. Use when adding, creating, or implementing a new cuTile operator/kernel in TileGym, or when asking how to register a new cuTile op.
- **Canonical source:** [../raw/skills/tilegym-adding-cutile-kernel/SKILL.md](../raw/skills/tilegym-adding-cutile-kernel/SKILL.md)
