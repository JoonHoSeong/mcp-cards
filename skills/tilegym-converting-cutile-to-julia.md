...
source: ../raw/skills/tilegym-converting-cutile-to-julia/SKILL.md
...
- **Skill ID:** `tilegym-converting-cutile-to-julia`
- **Purpose:** Converts cuTile Python GPU kernels (@ct.kernel) to cuTile.jl Julia equivalents. Handles kernel syntax translation, 0-indexed to 1-indexed conversion, broadcasting differences, memory layout (row-major to column-major), type system mapping, and launch API differences. Use when converting, porting, or translating cuTile Python kernels to Julia cuTile.jl, or debugging/optimizing existing Julia cuTile translations.
- **Canonical source:** [../raw/skills/tilegym-converting-cutile-to-julia/SKILL.md](../raw/skills/tilegym-converting-cutile-to-julia/SKILL.md)
...
- **Standard conversion** → Full workflow: [`translations/workflow.md`](../raw/skills/tilegym-converting-cutile-to-julia/translations/workflow.md)
- **Errors** (`MethodError`, `IRError`, numerical mismatch) → [`references/debugging.md`](../raw/skills/tilegym-converting-cutile-to-julia/references/debugging.md)
- **Quick reference** → [`references/api-mapping.md`](../raw/skills/tilegym-converting-cutile-to-julia/references/api-mapping.md) + [`references/critical-rules.md`](../raw/skills/tilegym-converting-cutile-to-julia/references/critical-rules.md)
- **Test patterns** → [`references/testing.md`](../raw/skills/tilegym-converting-cutile-to-julia/references/testing.md)
...
Full conversion checklist with post-conversion verification → [`translations/workflow.md`](../raw/skills/tilegym-converting-cutile-to-julia/translations/workflow.md)

## ⚠️ Top Pitfalls

The most dangerous translation errors. Full rules (17 total) in [`references/critical-rules.md`](../raw/skills/tilegym-converting-cutile-to-julia/references/critical-rules.md).
...
|---|---------|-------------|-------------------|
| 01 | [`add`](../raw/skills/tilegym-converting-cutile-to-julia/examples/01_add) | 1D `ct.load`/`ct.store`, alpha scaling, scalar broadcast, `fill`/`zeros`, keyword load/store | Starting point; basic TMA + element-wise patterns |
| 02 | [`matmul`](../raw/skills/tilegym-converting-cutile-to-julia/examples/02_matmul) | `muladd`, TF32 conversion, K-loop with `for`, 2D swizzle, standard Julia layout, `ct.@compiler_options` | MMA / tensor core operations |
| 03 | [`softmax`](../raw/skills/tilegym-converting-cutile-to-julia/examples/03_softmax) | Persistent scheduling, `for` loops, `gather`/`scatter`, `padding_mode`, multi-pass | Large-tensor reduction patterns |
...
|----------|----------|---------|
| **Workflows** | [`translations/workflow.md`](../raw/skills/tilegym-converting-cutile-to-julia/translations/workflow.md) | Full conversion workflow with todo list, validation loop, checklist |
| **Rules** | [`references/critical-rules.md`](../raw/skills/tilegym-converting-cutile-to-julia/references/critical-rules.md) | 17 Critical Rules for cuTile Python → Julia conversion |
| **API** | [`references/api-mapping.md`](../raw/skills/tilegym-converting-cutile-to-julia/references/api-mapping.md) | Python↔Julia bidirectional API mapping + kernel patterns |
| **Testing** | [`references/testing.md`](../raw/skills/tilegym-converting-cutile-to-julia/references/testing.md) | Julia-native test patterns, tolerances, failure diagnosis |
| **Debugging** | [`references/debugging.md`](../raw/skills/tilegym-converting-cutile-to-julia/references/debugging.md) | Julia-specific error diagnosis + IR debug commands |
| **Scripts** | [`scripts/validate_cutile_jl.py`](../raw/skills/tilegym-converting-cutile-to-julia/scripts/validate_cutile_jl.py) | Static validation for Julia anti-patterns (run it) |
