...
source: ../raw/skills/tilegym-cutile-python/SKILL.md
...
- **Skill ID:** `tilegym-cutile-python`
- **Purpose:** Expert cuTile programming assistant. Write high-performance GPU kernels using cuTile's tile-based programming model with proper validation and optimization. Supports deep agent orchestration for complex multi-kernel tasks.
- **Canonical source:** [../raw/skills/tilegym-cutile-python/SKILL.md](../raw/skills/tilegym-cutile-python/SKILL.md)
...
- **[01_implementation_lessons.md](../raw/skills/tilegym-cutile-python/guidelines/01_implementation_lessons.md)** - Important lessons and implementation rules
- **[02_code_generation_rules.md](../raw/skills/tilegym-cutile-python/guidelines/02_code_generation_rules.md)** - Specific code generation rules and patterns
- **[03_concepts.md](../raw/skills/tilegym-cutile-python/guidelines/03_concepts.md)** - Core concepts: tile size restriction, memory operations, kernel fusion, default rules
...
See **[examples/tilegym_and_examples_guide.md](../raw/skills/tilegym-cutile-python/examples/tilegym_and_examples_guide.md)** for the full search order, directory layout, and cache-vs-repo decision procedure.
...
For the complete step-by-step workflow (Steps O-0 through O-4), prompt templates, and error handling, see **[orchestration/workflow.md](../raw/skills/tilegym-cutile-python/orchestration/workflow.md)**.

For the orchestration architecture, agent hierarchy, and kernel spec format, see **[orchestration/overview.md](../raw/skills/tilegym-cutile-python/orchestration/overview.md)**.
