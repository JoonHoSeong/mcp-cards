...
source: ../raw/skills/tilegym-improve-cutile-kernel-perf/SKILL.md
...
- **Skill ID:** `tilegym-improve-cutile-kernel-perf`
- **Purpose:** Iteratively optimize cuTile kernel performance through systematic profiling, bottleneck analysis, IR comparison, and targeted tuning. Covers tile sizes, occupancy, autotune configs, TMA, latency hints, persistent scheduling, num_ctas, flush_to_zero, and IR-level debugging. Use when asked to "optimize cutile kernel", "improve kernel perf", "tune cutile performance", "make kernel faster", or iteratively benchmark and refine a cuTile GPU kernel in the TileGym project.
- **Canonical source:** [../raw/skills/tilegym-improve-cutile-kernel-perf/SKILL.md](../raw/skills/tilegym-improve-cutile-kernel-perf/SKILL.md)
