...
source: ../raw/skills/vss-generate-video-report/SKILL.md
...
- **Skill ID:** `vss-generate-video-report`
- **Purpose:** Use this skill when producing a VSS analysis report — Mode A per-clip VLM, Mode B incident-range via video-analytics. Not for standalone video summarization, real-time alerts or ad-hoc Q&A.
- **Canonical source:** [../raw/skills/vss-generate-video-report/SKILL.md](../raw/skills/vss-generate-video-report/SKILL.md)
