...
source: ../raw/skills/vss-manage-alerts/SKILL.md
...
- **Skill ID:** `vss-manage-alerts`
- **Purpose:** Use for VSS alert workflows — real-time monitoring, Alert-Bridge subscriptions, Slack notifications, incident queries, camera onboarding. Not for non-alert analytics.
- **Canonical source:** [../raw/skills/vss-manage-alerts/SKILL.md](../raw/skills/vss-manage-alerts/SKILL.md)
