...
source: ../raw/skills/vss-query-analytics/SKILL.md
...
- **Skill ID:** `vss-query-analytics`
- **Purpose:** Use this skill when reading video-analytics metrics, incidents, alerts, and sensor data via the VA-MCP server (port 9901). Not for live VLM or incident-range narrative reports.
- **Canonical source:** [../raw/skills/vss-query-analytics/SKILL.md](../raw/skills/vss-query-analytics/SKILL.md)
